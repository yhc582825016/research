...
def vllm_generate(grpo_sample_N,model,tokenizer,prompts,temperature,max_tokens):
    ...
    policy = model.policy
    sampling_params = SamplingParams(temperature=temperature, top_p=0.95, n=grpo_sample_N, max_tokens=max_tokens, logprobs =1,detokenize=False,ignore_eos=False, seed=random.randint(1, 5000)) # such seed avoid overfitting
    ...
    def train(self):
        ...
        for update in range(1, args.num_total_batches + 1):
            ...
            with torch.no_grad():
                ...
                responses = vllm_generate(args.grpo_sample_N,model,self.tokenizer, quesiton_string, args.temperature, max_tokens=generation_config.max_new_tokens)
                ...
                for mini_batch_start in tqdm(range(0, args.local_batch_size, args.local_mini_batch_size), desc='loss For&backward of 1 epoch of samples'):
                    ...
                    for micro_batch_start in range(0, args.local_mini_batch_size, args.per_device_train_batch_size):
                        ...
                        with accelerator.accumulate(model):
                            ...
                            # GRPO LOSS
                            kl = new_logprobs - ref_logprobs[micro_batch_inds]
                            ...
                            with torch.no_grad():
                                ...
                                refkl_stats[ppo_epoch_idx, minibatch_idx, gradient_accumulation_idx]= kl_statics.mean()
                                torch.cuda.empty_cache()
